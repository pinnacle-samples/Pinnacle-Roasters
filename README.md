...
- RCS agent configured through Pinnacle

### Installation

1. Clone the repository and navigate to the Pinnacle Cafe directory
...
- `PINNACLE_AGENT_NAME` (required): Your registered RCS agent name
...
### POST /
Main webhook endpoint for receiving RCS messages
...
- **rcs-js**: Pinnacle RCS SDK v2.0.4+
